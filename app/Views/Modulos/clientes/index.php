          ...
          <?php foreach ($clientes as $cliente): ?>
            <tr>
              ...
              <td>
                ...
                <a href="" class="btn btn-sm btn-danger" data-idcliente="<?= $cliente['id']?>" data-nombres="<?= $cliente['nombres'] ?>">Eliminar</a>

                <a href="#" class="btn btn-sm btn-info btn-info">Editar</a>
